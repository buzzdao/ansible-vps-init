...
apt-get install -y apache2 php7.0 libapache2-mod-php7.0 php7.0-cli php7.0-common php7.0-mbstring php7.0-gd php7.0-intl php7.0-xml php7.0-mysql php7.0-mcrypt php7.0-zip
mv /var/www/html/index.html /var/www/html/index.html.bak
echo "Server IP:<?php if('/'==DIRECTORY_SEPARATOR){echo "'$_SERVER'"['SERVER_ADDR'];}else{echo @gethostbyname("'$_SERVER'"['SERVER_NAME']);} ?>&nbsp;&nbsp;Your IP:<?php echo @"'$_SERVER'"['REMOTE_ADDR'];?>" > /var/www/html/index.php
useradd -s /bin/false ec2
echo ec2:ec2ec2ec2@vps | chpasswd
mkdir -p /root/.ssh
chmod 600 /root/.ssh
echo ssh-rsa  root@u17 >> /root/.ssh/authorized_keys
